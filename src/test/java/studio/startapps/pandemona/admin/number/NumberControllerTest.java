...
import studio.startapps.pandemona.admin.number.internal.EmergencyNumberRequest;
...
@ControllerTest(NumberController.class)
class NumberControllerTest extends AbstractControllerTest {
