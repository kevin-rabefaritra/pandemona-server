...
public class HealthCenterMobileControllerTest {
    ...
    void fetchHealthCentersShouldBeOk() throws Exception {
        given(healthCenterMobileService.findAll()).willReturn(List.of(
            new HealthCenterItem("Clinic 101", "Nowhere, Somewhere", CityEnum.ANTSIRABE, List.of("03399399393", "11001010101"), 28.4f, 18.2f, HealthCenterType.CLINIC),
            new HealthCenterItem("Toliara Hospital", "Nowhere, Somewhere", CityEnum.TOLIARA, List.of("111"), 28.4f, 8.2f, HealthCenterType.HOSPITAL)
        ));
        ...
        .andExpect(content().json("""
                [
                {'name': 'Clinic 101', 'address': 'Nowhere, Somewhere', 'city': 'ANTSIRABE', 'contacts': ['03399399393', '11001010101'], 'latitude': 28.4, 'longitude': 18.2, 'type': 'CLINIC'},
                {'name': 'Toliara Hospital', 'address': 'Nowhere, Somewhere', 'city': 'TOLIARA', 'contacts': ['111'], 'latitude': 28.4, 'longitude': 8.2, 'type': 'HOSPITAL'}
                ]
                """));
    }
}
