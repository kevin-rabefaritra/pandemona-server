...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        List<String> protectedEndpoints = List.of("/api/auth/**", "/api/drugstores/**", "/api/onduty-drugstores/**", "/api/cities", "/api/health-centers/**", "/api/numbers/**", "/api/endpoints/*", "/api/feed/**", "/api/reports/**");
        ...
        // 2. Mobile endpoints (POST)
        var mobilePostEndpoints = List.of("/api/mobile/v1/report", "/api/mobile/report");
        mobilePostEndpoints.forEach(endpoint -> {
            CorsConfiguration mobileConfiguration = buildCorsConfiguration("*", List.of("POST"), false);
            source.registerCorsConfiguration(endpoint, mobileConfiguration);
        });
